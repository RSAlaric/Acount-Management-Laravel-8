          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <div class="panel-body minimal">
                <center><h4><b><u>LISTE DES PERIODES</u></b></h4></center>
                  <div class="adv-table">
                    <table cellpadding="0" cellspacing="0" border="1" class="display table table-bordered" id="hidden-table-info">
                      <thead>
                        <tr>
                          <th class="centered"><center>  Début du Période  </center></th>
                          <th class="centered"><center>  Fin du Période  </center></th>
                          <th class="centered"><center>  Mois  </center></th>
                          <th class="centered"><center>  Rang de Traitement  </center></th>
                          <th class="centered"><center>  Rang de la période antérieure  </center></th>
                        </tr>
                      </thead>
                      <tbody>
                        @foreach ($periodes as $periode)
                          <tr class="gradeX">
                            <td class="centered"><center>  {{$periode->date_debut_p}}  </center></td>
                            <td class="centered"><center>  {{$periode->date_fin_p}}  </center></td>
                            <td class="centered"><center>  {{$periode->mois_p}}  </center></td>
                            <td class="centered"><center>  {{$periode->rang_traitement_p}}  </center></td>
                            <td class="centered"><center>  {{$periode->rang_anterieure_p}}  </center></td>
                          </tr>
                        @endforeach
                      </tbody>
                    </table>
