...
<head>
  ...
  <title>Dashboard - Technique de Précision</title>
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="#" class="logo"><b>TECHNIQUE D<span>E PRECISION</span></b></a>
      <!--logo end-->
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="periode.html">Traitement en debut Période</a></li>
              <li><a href="">Gestion de Mouvement</a></li>
