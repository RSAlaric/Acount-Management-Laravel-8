          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <div class="panel-body minimal">
                <center><h4><b><u>LISTE DES VILLES AVEC LEURS CODE POSTALE</u></b></h4></center>
                  <div class="adv-table">
                    <table cellpadding="0" cellspacing="0" border="1" class="display table table-bordered" id="hidden-table-info">
                      <thead>
                        <tr>
                          <th class="centered"><center>  Code Postale </center></th>
                          <th class="centered"><center>  Nom de la Ville  </center></th>
                        </tr>
                      </thead>
                      <tbody>
                        @foreach ($villes as $ville)
                          <tr class="gradeX">
                            <td class="centered"><center>  {{$ville->code_postale}}  </center></td>
                            <td class="centered"><center>  {{$ville->nom_ville}}  </center></td>
                          </tr>
                        @endforeach
                      </tbody>
                    </table>
