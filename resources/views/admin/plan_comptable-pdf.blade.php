...
<html lang="en">
  <head>
    ...
    <title>Plan Comptable - Liste</title>
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <div class="panel-body minimal">
                  ...
                  <div class="adv-table">
                    <table classe="centered" cellpadding="0" cellspacing="0" border="1" class="display table table-bordered" id="hidden-table-info">
                        <thead>
                        <tr>
                          <th class="centered"><center>  Compte<  </center></th>
                          <th class="centered"><center>  Libellé  </center></th>
                          <th class="centered"><center>  Code Bilan  </center></th>
                      ...
                      <tbody>
                        @foreach($pcgs as $pcgs)
                          <tr class="gradeX">
                            <td class="centered"><center>  {{$pcgs->$COMPTE}}  </center></td>
                            <td class="centered"><center>  {{$pcgs->$LIBELLEE}}  </center></td>
                            <td class="centered"><center>  {{$pcgs->BILAN}}  </center></td>
