...
class CreatePcomptableDetaillesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pcomptable_detailles', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pcomptable_detailles');
    }
}
